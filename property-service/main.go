...
import (
	...
	"accommodation-booking-system/property-service/pkg/handlers"
...
func main() {
	...
	propertyServiceServer := handlers.NewPropertyServiceServer(dbManager, bookingClient)
	proto.RegisterPropertyServiceServer(s, propertyServiceServer)
